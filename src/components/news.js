...
const News = () => {
  ...
  const newsApi = "https://api.nasa.gov/planetary/apod?api_key=k6LiFxfOTe9ulpksPIVs3Ix4BfvYYXAOfKwJK5YK&date=2020-11-18";
  ...
  const roverApi = "https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?sol=1000&camera=mast&api_key=k6LiFxfOTe9ulpksPIVs3Ix4BfvYYXAOfKwJK5YK";
